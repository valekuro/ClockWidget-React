 ...
 * @returns
 */
export default function TextArea({ variant, placeholder, startAdornments, onReset, value, onFocus, onBlur, onChange, inputRef, onClickReset }: TextAreaProps) {
  return (
    <TextAreaContainer>
      <TextAreaField ref={inputRef} onFocus={onFocus} onBlur={onBlur} placeholder={placeholder} value={value} variant={variant} onChange={onChange} maxLength={150} />
...
export const TextAreaField = styled.textarea<{ variant: string }>`
